...
const exec = async (args: string[]) => {
  ...
  try {
    // @ts-expect-error - there is literally no file extension, as if we include one commander does not respect our shebang to accommodate Windows users
    await import('../libnest');
  } catch (err) {
